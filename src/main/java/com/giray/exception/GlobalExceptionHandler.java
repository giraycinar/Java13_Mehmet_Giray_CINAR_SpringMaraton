...
import static com.giray.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> hastaneOtomasyonuHandler(HastaneOtomasyonException hastaneOtomasyonuException){
        return new ResponseEntity<>(createErrorMessage(hastaneOtomasyonuException,hastaneOtomasyonuException.getErrorType()),
                hastaneOtomasyonuException.getErrorType().getHttpStatus());
    }
